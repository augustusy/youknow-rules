...
function get_emoji(emojip, sname) {
    var Lmoji = { "🏳️‍🌈": ["流量", "时间", "应急", "过期", "Bandwidth", "expire"], "🇦🇹": ["AT", "Austria", "奥地利"], "🇦🇺": ["AU", "Australia","澳大利亚", "澳洲"], "🇧🇪": ["BE", "比利时"], "🇧🇬": ["BG", "Bulgaria", "保加利亚"],  "🇨🇦": ["CA", "Canada", "CAN", "加拿大"], "🇨🇭": ["CH", "Switzerland", "瑞士"], "🇨🇿": ["CZ", "Czechia", "捷克"], "🇩🇪": ["DE", "German", "德国", "德國"], "🇩🇰": ["DK","DNK","丹麦"], "🇪🇸": ["ES", "Spain", "西班牙"], "🇪🇺": ["EU", "欧盟"], "🇫🇮": ["FI", "Finland", "芬兰"], "🇫🇷": ["FR", "France", "法国", "法國"], "🇬🇧": ["UK", "GB", "England", "United Kingdom", "英国", "英"], "🇲🇴": ["MO", "Macao", "CTM", "澳门", "澳門"], "🇰🇿": ["KZ", "Kazakhstan", "哈萨克斯坦"], "🇭🇺": ["HU", "Hungary", "匈牙利"], "🇭🇰": ["HK", "Hongkong", "Hong Kong", "HongKong", "HONG KONG","香港", "HKT", "HKBN", "HGC", "WTT", "CMI", "穗港", "港"], "🇮🇩": ["ID", "Indonesia", "印尼", "印度尼西亚"], "🇮🇪": ["IE", "Ireland", "IRELAND", "爱尔兰", "愛爾蘭"], "🇮🇱": ["IL", "Israel", "以色列"], "🇮🇳": ["IN", "India", "IND", "INDIA","印度"], "🇮🇸":["IS","ISL", "Iceland", "冰岛"],"🇰🇵": ["KP", "朝鲜"], "🇰🇷": ["KR", "Korea", "KOR", "韩国", "韩", "韓"], "🇱🇻": ["LV", "Latvia", "Latvija", "拉脱维亚"], "🇲🇽️": ["MX", "MEX", "墨西哥"], "🇲🇾": ["MY", "Malaysia", "MALAYSIA", "马来西亚", "馬來西亞"], "🇳🇱": ["NL", "Netherlands", "荷兰", "荷蘭"], "🇵🇭": ["PH", "Philippines", "菲律宾", "菲律賓"], "🇷🇴": ["RO", "Romania", "罗马尼亚"], "🇷🇺": ["RU", "Russia", "俄罗斯", "俄国", "俄羅斯"], "🇸🇦": ["SA", "Arabia", "Saudi Arabia", "沙特阿拉伯", "沙特", "阿拉伯"], "🇸🇪": ["SE", "Sweden", "瑞典"], "🇸🇬": ["SG", "Singapore","SINGAPORE", "新加坡"], "🇹🇭": ["TH", "Thailand", "泰国", "泰國"], "🇹🇷": ["TR", "Turkey", "土耳其"], "🇹🇼": ["TW", "Taiwan","TAIWAN", "台湾", "CHT", "台", "HINET"], "🇺🇸": ["US", "USA", "America", "United States", "美国", "美"], "🇻🇳": ["VN", "Vietnam", "越南"], "🇮🇹": ["Italy", "IT", "Nachash", "意大利", "義大利"], "🇿🇦": ["ZA", "South Africa", "南非"], "🇦🇪": ["AE", "United Arab Emirates", "阿联酋"], "🇧🇷": ["BR", "Brazil", "巴西"], "🇯🇵": ["JP", "Japan","JAPAN", "日", "日本"], "🇦🇷": ["AR", "Argentina", "阿根廷"], "🇳🇴": ["NO", "Norway", "挪威"], "🇨🇳": ["CN", "China", "回国", "中国", "back"],"🇵🇱": ["PL", "POL", "Poland", "波兰"], "🇨🇱": ["CL", "Chile", "智利"],"🇳🇿":["NZ", "New Zealand", "新西蘭", "新西兰"],"🇭🇷": ["HR", "Croatia", "克罗地亚"],"🇵🇹": ["PT", "Portugal", "葡萄牙"],"🇦🇱": ["AL", "Albania", "阿尔巴尼亚"],"🇪🇪": ["EE", "Estonia", "爱沙尼亚"],"🇸🇰": ["SK", "Slovakia", "斯洛伐克"],"🇱🇺": ["LU", "Luxembourg", "卢森堡"],"🇨🇾": ["CY", "Cyprus", "塞浦路斯"] }
